          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="province" required="required">
                                ...
                                <option value="Province No. 1">Gujarat</option>
                                <!-- <option value="Province No. 2">Ahemedabad</option> 
                                <option value="Bagmati Pradesh">Gandhinagar</option>
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="zone" required="required">
                                ...
                                <option value="Bagmati">North</option>
                                <option value="Bheri">South</option>
                                <option value="Dhawalagiri">East</option>
                                <option value="Gandaki">West</option>
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="district" required="required">
                                ...
                                <option value="Taplejung">Mehsana</option>
